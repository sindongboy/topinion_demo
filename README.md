...
- topinion-demo-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- topinion-demo-ui: main application module, development time
- topinion-demo-production: module that produces a production mode WAR for deployment
